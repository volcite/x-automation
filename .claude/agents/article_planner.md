...
2. **過去1ヶ月の分析トレンド**: `article_analysis_history.json` から繰り返し上位に来ているテーマ・パターン
...
6. **海外の最新動向**: 海外発の先取りネタ（OpenAI/Anthropic公式アップデート、海外開発者の事例、論文など）を優先評価
7. **5本セットとしての多様性**: 5本が似通わないよう、切り口・難易度・スタイルをバラけさせる
