...
2. `data/giveaway_note_result.json`（Note記事の公開URL ← 投稿3〜5に埋め込む）
3. `data/giveaway_note_draft.json`（Note記事の本文 ← 記事の要点を投稿文に反映）
...
**構成:**
- フック（記事の核心的な価値を一文で伝える）
- 記事の概要（何が書いてあるか、誰に役立つか）
- 「3日間限定で無料配布中です」
